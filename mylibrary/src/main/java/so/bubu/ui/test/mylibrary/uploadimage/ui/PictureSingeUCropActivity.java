...
import so.bubu.ui.test.mylibrary.uploadimage.model.AspectRatio;
...
import so.bubu.ui.test.mylibrary.uploadimage.util.SelectedStateListDrawable;
import so.bubu.ui.test.mylibrary.uploadimage.util.ToolbarUtil;
import so.bubu.ui.test.mylibrary.uploadimage.util.Utils;
import so.bubu.ui.test.mylibrary.uploadimage.weight.CropImageView;
import so.bubu.ui.test.mylibrary.uploadimage.weight.GestureCropImageView;
import so.bubu.ui.test.mylibrary.uploadimage.weight.HorizontalProgressWheelView;
import so.bubu.ui.test.mylibrary.uploadimage.weight.OverlayView;
import so.bubu.ui.test.mylibrary.uploadimage.weight.SweetAlertDialog;
import so.bubu.ui.test.mylibrary.uploadimage.weight.TransformImageView;
import so.bubu.ui.test.mylibrary.uploadimage.weight.UCropView;
...
public class PictureSingeUCropActivity extends FragmentActivity {
    ...
    /**
     * This method extracts {@link so.bubu.ui.test.mylibrary.uploadimage.UCrop.Options #optionsBundle} from incoming intent
    ...
    protected void cropAndSaveImage() {
        ...
        mGestureCropImageView.cropAndSaveImage(mCompressFormat, mCompressQuality, new BitmapCropCallback() {
            ...
            public void onCropFailure(@NonNull Throwable t) {
                Log.e("zhengheng", "onCropFailure "+ t.getMessage());
                setResultError(t);
            }
        });
    }
