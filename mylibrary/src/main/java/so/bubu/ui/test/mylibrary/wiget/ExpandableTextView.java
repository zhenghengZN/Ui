...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private static final int INTERVAL_LINE = 4;
...
//    private Drawable mCollapseDrawable;
    ...
    private boolean isShowAll = false, isClick = false;
    ...
    public void onClick(final View view) {
        if (mButton.getVisibility() != View.VISIBLE) {
            ...
            if (Helper.isNotNull(mListener) && isClick) {
                mListener.onGoneClick();
            }
...
//        mButton.setImageDrawable(mCollapsed ? mExpandDrawable : mCollapseDrawable);
        ...
        if (mCollapsed) {
            ...
            int endHeight = getHeight() + mTextHeightWithMaxLines - mTv.getHeight() - mButton.getHeight();
            animation = new ExpandCollapseAnimation(this, getHeight(), endHeight);
            positionMap.put(textPosition, endHeight);
        }
    ...
    public void setIsShowAll(boolean isShowAll, int position) {
        this.isShowAll = isShowAll;
        if (0 != mCollapsedHeight && !isShowAll) {
            getLayoutParams().height = mCollapsedHeight;
        } else {
            if (positionMap.containsKey(textPosition)) {
                getLayoutParams().height = positionMap.get(position);
            }
        }
        requestLayout();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mTv.getLineCount() <= (mMaxCollapsedLines + INTERVAL_LINE)) {
            isClick = true;
            if (Helper.isNotNull(mListener)) {
                mListener.onOverLine();
            }
            return;
        }
    ...
    public void setText(@Nullable CharSequence text, int position) {
        mRelayout = true;
