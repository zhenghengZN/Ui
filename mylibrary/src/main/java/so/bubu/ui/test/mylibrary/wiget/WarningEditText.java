...
public class WarningEditText extends EditText
    ...
    public WarningEditText(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() { 
        ...
        if (Helper.isNull(mClearDrawable)) {
        	mClearDrawable = getResources().getDrawable(R.drawable.warning);
        } 
        mClearDrawable.setBounds(0, 0, ResourceUtil.Dp2Px(25), ResourceUtil.Dp2Px(25));
